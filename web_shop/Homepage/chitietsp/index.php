...
<body>
    <div class="main">
            ...
            <nav class="nav__pc">
                ...
                <ul class="nav__list">
                    ...
                    foreach ($thumucList as $item) {
                        echo '<li >
                            <a class="nav__link" href="../index.php?id=' . $item['name'] . '"><button name = "hang" style="background:none;width:60px">' . $item['name'] . '</button></a>
                            </li>';
                    }
                    $noidung = '';
                    foreach ($menuList as $item) {
                        echo '<li id="menu__pc">
                                <a  class="nav__link" href="../index.php?id=' . $item['content'] . '"><button style="background:none;"> ' . $item['Name'] . '</button> </a>
                            </li>';
                    }
                    echo '
                        <li>
                    ...
                    if ($_SESSION['login'] == 'khach hang') {
                        ...
                        echo '<div class="dropdown " style="padding-left:15px;padding-right:50px">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="../Tk/changeinformation.php?id=' . $_SESSION['login'] . '">Đổi Thông Tin</a></li>
                                    <li><a class="dropdown-item" href="../Tk/changePassword.php?id=' . $_SESSION['login'] . '">Đội Mật Khẩu</a></li>
                    ...
                    <div id="container" class="container">
                        <div class="row justify-content-around">
                            <form action="#" method="post" style="margin-top: 10%;">
                                ...
                                <tr>
                                    <td>
                                        <input style="margin-bottom: 1%;" type="checkbox" id="checkbox" name="checkbox"
                                            <?php echo ($check) ? "checked" : '' ?>>
        ...
        <section class="container"
            style="margin-top: 2%;background-color: white;margin-left: 2.5%;padding-left:3%;height:auto;margin-bottom:50px">
            <div class="container-fluid">
                <div>
                    ...
                    if (isset($_GET['id'])) {
                        ...
                        $sql_ct = 'SELECT * FROM ct_sanpham where id_CTSP=' . $_GET['id'] . '';
                        $item = executeSingleResult($sql_ct);
                        if(executeResult($sql_ct)){
                            if ($item['nfc'] == 1) {
                                $nfc = 'có';
                            } else {
                                $nfc = 'không';
                            ...
                            $item['kichthuoc']=$item['dophangiai']=$item['congnghemh']=$item['tinhnangmh']=$item['soquet']=$item['hedieuhanh']
                            =$item['wifi']=$item['bluetooth']=$jack=$nfc=$item['mang']=$item['gps']=$item['pin']=$item['sac']= $item['congsac']
                            =$item['kichthuocsp']=$item['trongluong']=$item['matlung']=$item['khung']=$item['camsau']=$item['tinhnangcamsau']
                            =$item['quay']=$item['camtruoc']=$item['ram']= $item['gb']=$item['kieumh']=$item['tinhnangdacbiet']=$item['cpu']='';
                        }
                        
                        echo
                        '<table style="width:100%;margin-left:2%;border:none">
                    <tr> 
                        <td colspan="2">
                            <p class="title"><b style ="font-size:18px" >' . $product['title'] . '</b></p>
                    ...
                    <tr>
                        <th rowspan="2">
                            ...
                            <p class="gia"><b><i>Giá: ' . number_format($product['price']) . '&ensp;VNG</i></b></p>
                        </th>
                        <td >
                        <p class="mota">kích thước:' . $item['kichthuoc'] . '<br><br>Tính năng màn hình:' . $item['tinhnangmh'] . '
                        <br><br>Camera sau:' . $item['camsau'] . '<br><span id="quay"><br>Khả năng quay:' . $item['quay'] . '</span></p>
                        </td>
                    </tr>
                    <tr>
                    </tr>
                    <tr>
                        <td colspan="2">
                                <a href=../oder/add.php?id=' . $id . '><button class="btn_1"  >Mua Ngay</button></a>
                                <a href=add.php?id=' . $product['id'] . '><button  class="btn_1"  >Thêm Vào Giỏ </button></a>
                                <button class="btn_2"  >Mua Trả Góp</button>
                                <button class="btn_2"  data-bs-target="#myModal" data-bs-toggle="modal">Chi tiết </button>
                        </td>
                    </tr>                  
                    </table> ';
                    }
                    ...
                    $item = executeSingleResult($sql_ct);
                    if ($item) {
                        echo '   <div class="modal" id="myModal" style="font-size:18px" >
                                <div class="modal-dialog modal-dialog-scrollable modal-lg">
                                <div class="modal-content" >
                                <div class="modal-header">
                                    <h2 style="margin-top:0px ;" >Chi tiết sản phẩm</h2>
                                ...
                                <div class="modal-body">
                                    <h4>Màn hình </h4>
                                        <table class="table table-striped">
                                            <tr>
                                                <td class="tieude" >Kích thước màn hình</td>
                                                <td class="chitiet">' . $item['kichthuoc']. '</td>
                                            </tr>
                                            <tr>
                                                <td class="tieude" >Độ phân giải màn hình</td>
                                                <td class="chitiet">' . $item['dophangiai'] . '</td>
                                            </tr>
                                            <tr>
                                                <td class="tieude" >Công nghệ màn hình</td>
                                                <td class="chitiet">' . $item['congnghemh'] . '</td>
                                            </tr>
                                            <tr>
                                                <td class="tieude" >Tính năng màn hình</td>
                                                <td class="chitiet">' . $item['tinhnangmh'] . '</td>
                                            </tr>
                                            <tr>
                                                <td class="tieude" >Tần số quét</td>
                                                <td class="chitiet">' . $item['soquet'] . '</td>
                                            </tr>
                                        </table>
                                    <h4>Giao tiếp & kết nối</h4>
                                        <table class="table table-striped">
                                            <tr>
                                                <td class="tieude" >Hệ điều hành</td>
                                                <td class="chitiet">' . $item['hedieuhanh'] . '</td>
                                            </tr>
                                            <tr>
                                                <td class="tieude" >Wi-Fi</td>
                                                <td class="chitiet">' . $item['wifi'] . '</td>
                                            </tr>
                                            <tr>
                                                <td class="tieude" >Bluetooth</td>
                                                <td class="chitiet">' . $item['bluetooth'] . '</td>
                                            </tr>
                                            <tr>
                                                <td class="tieude" >Jack tai nghe 3.5</td>
                                                <td class="chitiet">' . $jack . '</td>
                                            </tr>
                                            <tr>
                                                <td class="tieude" >Công nghệ NFC</td>
                                                <td class="chitiet">' . $nfc . '</td>
                                            </tr>
                                            <tr>
                                                <td class="tieude" >Hỗ trợ mạng</td>
                                                <td class="chitiet">' . $item['mang'] . '</td>
                                            </tr>
                                            <tr>
                                                <td class="tieude" >GPS</td>
                                                <td class="chitiet">' . $item['gps'] . '</td>
                                            </tr>
                                        </table>
                                    <h4Pin & công nghệ sạc</h4>
                                        <table class="table table-striped">
                                            <tr>
                                                <td class="tieude" >Pin</td>
                                                <td class="chitiet">' . $item['pin'] . '</td>
                                            </tr>
                                            <tr>
                                                <td class="tieude" >Công nghệ sạc</td>
                                                <td  class="chitiet">' . $item['sac'] . '</td>
                                            </tr>
                                            <tr>
                                                <td class="tieude" >Cổng sạc</td>
                                                <td class="chitiet">' . $item['congsac'] . '</td>
                                            </tr>
                                            </table>
                                        <h4>Thiết kế & Trọng lượng</h4>
                                            <table class="table table-striped">
                                                <tr>
                                                    <td class="tieude" >Kích thước</td>
                                                    <td class="chitiet">' . $item['kichthuocsp'] . '</td>
                                                </tr>
                                                <tr>
                                                    <td class="tieude" >Trọng lượng</td>
                                                    <td class="chitiet">' . $item['trongluong'] . '</td>
                                                </tr>
                                                <tr>
                                                    <td class="tieude" >Chất liệu mặt lưng</td>
                                                    <td class="chitiet">' . $item['matlung'] . '</td>
                                                </tr>
                                                <tr>
                                                    <td class="tieude" >Chất liệu khung viền</td>
                                                    <td class="chitiet">' . $item['khung'] . '</td>
                                                </tr>
                                            </table>
                                        <h4>Camera sau</h4>
                                            <table class="table table-striped">
                                                <tr>
                                                    <td class="tieude" >Camera sau</td>
                                                    <td class="chitiet">' . $item['camsau'] . '</td>
                                                </tr>
                                                <tr>
                                                    <td class="tieude" >Tính năng camera</td>
                                                    <td class="chitiet">' . $item['tinhnangcamsau'] . '</td>
                                                </tr>
                                                <tr>
                                                    <td class="tieude" >Quay video</td>
                                                    <td class="chitiet">' . $item['quay'] . '</td>
                                                </tr>
                                            </table>
                                        <h4>Camera trước</h4>
                                            <table class="table table-striped">
                                                <tr>
                                                    <td class="tieude" >Camera trước</td>
                                                    <td class="chitiet">' . $item['camtruoc'] . '</td>
                                                </tr>
                                            </table>
                                        <h4>RAM & lưu trữ</h4>
                                            <table class="table table-striped">
                                                <tr>
                                                    <td class="tieude" >Dung lượng RAM</td>
                                                    <td class="chitiet">' . $item['ram'] . '</td>
                                                </tr>
                                                <tr>
                                                    <td class="tieude" >Bộ nhớ trong</td>
                                                    <td class="chitiet">' . $item['gb'] . '</td>
                                                </tr>
                                            </table>
                                        <h4>Thông số khác</h4>
                                            <table class="table table-striped">
                                                <tr>
                                                    <td class="tieude" >Kiểu màn hình</td>
                                                    <td class="chitiet">' . $item['kieumh'] . '</td>
                                                </tr>
                                            </table>
                                        <h4>Tiện ích khác</h4>
                                            <table class="table table-striped">
                                                <tr>
                                                    <td class="tieude" >Tính năng đặc biệt</td>
                                                    <td class="chitiet">' . $item['tinhnangdacbiet'] . '</td>
                                                </tr>
                                            </table>
                                        <h4>Vi xử lý & đồ họa</h4>
                                            <table class="table table-striped">
                                                <tr>
                                                    <td class="tieude" >Chipset</td>
                                                    <td class="chitiet">' . $item['cpu'] . '</td>
                                                </tr>
                                            </table>
                                    </div>
                                    <div class="modal-footer">
                                        <button style="width:100%;height: 40px;border-radius: 20px;" type="button" class="btn btn-danger" data-bs-dismiss="modal"><span style="font-size:20px ;">x Đóng</span> </button>
                                    </div>';
                    }
                    ?>
                </div>
